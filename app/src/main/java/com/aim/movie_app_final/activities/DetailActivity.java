...
import com.aim.movie_app_final.adapters.CastAdapter;
import com.aim.movie_app_final.adapters.GenreRecyclerAdapter;
import com.bumptech.glide.Glide;
import com.bumptech.glide.load.resource.bitmap.RoundedCorners;
import com.bumptech.glide.request.RequestOptions;
import com.aim.movie_app_final.database.AppDatabase;
import com.aim.movie_app_final.database.entities.Favorite;
...
import com.aim.movie_app_final.models.Genre;
...
public class DetailActivity extends AppCompatActivity implements ActionBarTitle {
    ...
    public void loadData() {
            ...
            Call<Movie> movieDetail = movieApiInterface.getMovie(id, Api.API_KEY);
            movieDetail.enqueue(new Callback<Movie>() {
                @Override
                public void onResponse(Call<Movie> call, Response<Movie> response) {
                    if(response.isSuccessful() && response.body() != null){
                        Call<CastResponse> casts = movieApiInterface.getCast(id, Api.API_KEY);
...
//
    ...
    private void setActivityContent(Movie movie, CastResponse castResponse){
        ...
        Glide.with(DetailActivity.this)
                .load(Api.IMG_URL_200 + movie.getBackdrop())
                .into(cover);

        Glide.with(DetailActivity.this)
                .load(Api.IMG_URL_200 + movie.getCover())
